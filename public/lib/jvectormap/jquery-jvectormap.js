...
jvm.$ = jQuery, Array.prototype.indexOf || (Array.prototype.indexOf = function(searchElement, fromIndex) {
  ...
  if (isFinite(transX) && isFinite(transY) && isFinite(scale)) {
  ...
  bindElementEvents: function() {
    ...
    this.container.mousemove(function(e) {
      ...
      var baseVal = jvm.$(this).attr("class").baseVal || jvm.$(this).attr("class"),
        ...
        tipTextRegion = "region" == type ? map.mapData.paths[code].name : map.markers[code].config.name || "",
        tipText = '<div class="tooltipContainer"><div class="tooltipInfoContainer"><span class="tooltipPropertyValue">' + tipTextRegion + '</span></div></div>',
        tipShowEvent = jvm.$.Event(type + "TipShow.jvectormap"),
        overEvent = jvm.$.Event(type + "Over.jvectormap");
      "mouseover" == e.type ? (map.container.trigger(overEvent, [code]), overEvent.isDefaultPrevented() || element.setHovered(!0), map.tip.html(tipText), map.container.trigger(tipShowEvent, [map.tip, code]), tipShowEvent.isDefaultPrevented() || (map.tip.show(), map.tipWidth = map.tip.width(), map.tipHeight = map.tip.height())) : (element.setHovered(!1), map.tip.hide(), map.container.trigger(type + "Out.jvectormap", [code]))
  ...
  createTip: function() {
    ...
    this.tip = jvm.$("<div/>").addClass("jvectormap-tip").appendTo(jvm.$(".jvectormap-vis")), this.container.mousemove(function(e) {
      var left = e.pageX - 300 - map.tipWidth,
